...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        // 设置配送费
        orders.setDeliveryFee(new BigDecimal("6.00"));
    ...
    public OrderPaymentVO payment(OrdersPaymentDTO ordersPaymentDTO) throws Exception {
        log.info("开始处理支付请求，订单号：{}，支付方式：{}", ordersPaymentDTO.getOrderNumber(), ordersPaymentDTO.getPayMethod());
        ...
        log.info("支付处理完成，订单号：{}", ordersPaymentDTO.getOrderNumber());
    ...
    public void paySuccess(String outTradeNo) {
        ...
        // 检查订单是否存在
        if (ordersDB == null) {
            log.error("订单不存在，订单号：{}，用户ID：{}", outTradeNo, userId);
